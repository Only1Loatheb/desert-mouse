  ...
  object DuneMap {
    ...
    val duneMap: DuneMapGraph = {
      ...
      val edges: Set[LUnDiEdge[Territory] with EdgeCopy[LUnDiEdge]{type L1 = GetSectorOnEdgeEnd}] = Set(
        ...
        , (SihayaRidge ~+ GaraKulon)(((_, t) => (t: @unchecked) match {case SihayaRidge => Set(Sector8); case GaraKulon => Set(Sector7)}): GetSectorOnEdgeEnd)
        ...
        , (RedChasm ~+ SouthMesa)(((_, t) => (t: @unchecked) match {case RedChasm => Set(Sector6); case SouthMesa => Set(Sector5)}): GetSectorOnEdgeEnd)
        ...
        , (Meridan ~+ HabbanyaRidgeFlat)(((_, t) => (t: @unchecked) match {case Meridan => Set(Sector0); case HabbanyaRidgeFlat => Set(Sector17)}): GetSectorOnEdgeEnd)
        ...
        , (TheGreaterFlat ~+ TheGreatFlat)(((_, t) => (t: @unchecked) match {case TheGreaterFlat => Set(Sector15); case TheGreatFlat => Set(Sector14)}): GetSectorOnEdgeEnd)
        , (TheGreatFlat ~+ WindPass)(((_, _) => Set(Sector14)): GetSectorOnEdgeEnd)
        , (TheGreatFlat ~+ PlasticBasin)(((_, t) => (t: @unchecked) match {case TheGreatFlat => Set(Sector14); case PlasticBasin => Set(Sector13)}): GetSectorOnEdgeEnd)
        , (TheGreatFlat ~+ FuneralPlains)(((_, _) => Set(Sector14)): GetSectorOnEdgeEnd)
        , (FuneralPlains ~+ PlasticBasin)(((_, t) => (t: @unchecked) match {case FuneralPlains => Set(Sector14); case PlasticBasin => Set(Sector13)}): GetSectorOnEdgeEnd)
        ...
        , (RockOutcroppings ~+ BrokenLand)(((_, t) => (t: @unchecked) match {case RockOutcroppings => Set(Sector12); case BrokenLand => Set(Sector11)}): GetSectorOnEdgeEnd)
        ...
        , (Arrakeen ~+ RimWallWest)(((_, t) => (t: @unchecked) match {case Arrakeen => Set(Sector9); case RimWallWest => Set(Sector8)}): GetSectorOnEdgeEnd)
        , (RimWallWest ~+ ImperialBasin)(((_, t) => (t: @unchecked) match {case RimWallWest => Set(Sector8); case ImperialBasin => Set(Sector9)}): GetSectorOnEdgeEnd)
        ...
        , (ShieldWall ~+ FalseWallEast)(((prevSector, t) => (t: @unchecked) match {case ShieldWall => Set(Sector7, Sector8); case FalseWallEast => Set(prevSector)}): GetSectorOnEdgeEnd)
        , (ShieldWall ~+ TheMinorErg)(((_, _) => Set(Sector7)): GetSectorOnEdgeEnd)
        , (TheMinorErg ~+ FalseWallEast)(((prevSector, t) => (t: @unchecked) match {case TheMinorErg => if (prevSector == Sector8) Set(Sector7) else Set(prevSector); case FalseWallEast => Set(prevSector)}): GetSectorOnEdgeEnd)
        ...
        , (FalseWallSouth ~+ CielagoNorth)(((_, t) => (t: @unchecked) match {case FalseWallSouth => Set(Sector3); case CielagoNorth => Set(Sector2)}): GetSectorOnEdgeEnd)
        , (FalseWallSouth ~+ TueksSietch)(((_, _) => Set(Sector4)): GetSectorOnEdgeEnd)
        , (CielagoNorth ~+ HargPass)(((_, t) => (t: @unchecked) match {case CielagoNorth => Set(Sector2); case HargPass => Set(Sector3)}): GetSectorOnEdgeEnd)
        , (CielagoNorth ~+ PolarSink)(((_, t) => (t: @unchecked) match {case CielagoNorth => Set(Sector0, Sector1, Sector2); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (CielagoNorth ~+ WindPassNorth)(((_, t) => (t: @unchecked) match {case CielagoNorth => Set(Sector0); case WindPassNorth => Set(Sector17)}): GetSectorOnEdgeEnd)
        ...
        , (CielagoWest ~+ WindPassNorth)(((_, t) => (t: @unchecked) match {case CielagoWest => Set(Sector0); case WindPassNorth => Set(Sector17)}): GetSectorOnEdgeEnd)
        , (CielagoWest ~+ WindPass)(((_, t) => (t: @unchecked) match {case CielagoWest => Set(Sector17); case WindPass => Set(Sector16)}): GetSectorOnEdgeEnd)
        ...
        , (WindPass ~+ CielagoWest)(((_, t) => (t: @unchecked) match {case WindPass => Set(Sector16); case CielagoWest => Set(Sector17)}): GetSectorOnEdgeEnd)
        , (WindPass ~+ WindPassNorth)(((_, _) => Set(Sector16)): GetSectorOnEdgeEnd)
        , (WindPass ~+ PolarSink)(((_, t) => (t: @unchecked) match {case WindPass => Set(Sector13, Sector14, Sector15); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (WindPass ~+ HaggaBasin)(((_, t) => (t: @unchecked) match {case WindPass => Set(Sector13); case HaggaBasin => Set(Sector12)}): GetSectorOnEdgeEnd)
        , (WindPass ~+ PlasticBasin)(((_, _) => Set(Sector13)): GetSectorOnEdgeEnd)
        , (PlasticBasin ~+ HaggaBasin)(((_, _) => Set(Sector12)): GetSectorOnEdgeEnd)
        , (PlasticBasin ~+ Tsimpo)(((prevSector, t) => (t: @unchecked) match {case PlasticBasin => Set(Sector11, Sector12); case Tsimpo => Set(Sector11, Sector12)}): GetSectorOnEdgeEnd)
        , (PlasticBasin ~+ SietchTabr)(((_, _) => Set(Sector13)): GetSectorOnEdgeEnd)
        , (Tsimpo ~+ HaggaBasin)(((prevSector, t) => (t: @unchecked) match {case Tsimpo => Set(prevSector); case HaggaBasin => Set(Sector11, Sector12)}): GetSectorOnEdgeEnd)
        ...
        , (ImperialBasin ~+ PolarSink)(((_, t) => (t: @unchecked) match {case ImperialBasin => Set(Sector9); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (ImperialBasin ~+ Arsunt)(((_, _) => Set(Sector10)): GetSectorOnEdgeEnd)
        , (ImperialBasin ~+ Carthag)(((_, _) => Set(Sector10)): GetSectorOnEdgeEnd)
        , (FalseWallEast ~+ PolarSink)(((_, t) => (t: @unchecked) match {case FalseWallEast => Set(Sector4, Sector5, Sector6, Sector7, Sector8); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (FalseWallEast ~+ HargPass)(((_, _) => Set(Sector4)): GetSectorOnEdgeEnd)
        , (HargPass ~+ PolarSink)(((_, t) => (t: @unchecked) match {case HargPass => Set(Sector3); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (WindPassNorth ~+ PolarSink)(((_, t) => (t: @unchecked) match {case WindPassNorth => Set(Sector16, Sector17); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (HaggaBasin ~+ PolarSink)(((_, t) => (t: @unchecked) match {case HaggaBasin => Set(Sector12); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
        , (HaggaBasin ~+ Arsunt)(((_, _) => Set(Sector11)): GetSectorOnEdgeEnd)
        , (Arsunt ~+ PolarSink)(((_, t) => (t: @unchecked) match {case Arsunt => Set(Sector10, Sector11); case PolarSink => Set(FakePolarSector)}): GetSectorOnEdgeEnd)
